...
export default function QuickUploadStudentPage() {
...
const downloadQuickTemplate = async () => {
    ...
    try {
        ...
        "/reports/students/quick-import/template",
        payload,
        { responseType: "blob" }
        );
  ...
  const uploadStudents = async () => {
    ...
    try {
      ...
      await api.post("/reports/students/quick-import", formData);
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 h-[420px] overflow-y-auto">
          ...
          <p className="font-semibold mb-2">
            Student Quick Upload Instructions
          </p>

          <ol className="text-sm text-gray-600 space-y-2 list-decimal pl-4">

            <li>
              Select the fields for quick upload of students by clicking on Download Template.
            </li>
      ...
      <div className="mt-6 bg-white border border-gray-200 rounded-lg p-6">
        ...
        <div className="bg-white w-[900px] rounded-lg shadow-lg">
            ...
            <h2 className="font-semibold text-lg">
                Select Fields for Student Quick Upload
            </h2>
