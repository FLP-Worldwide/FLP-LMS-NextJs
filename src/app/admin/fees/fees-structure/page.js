...
import StructureTab from "@/components/admin/fees/StructureTab";
...
const inventoryMenus = [
  { label: "Fees Type", href: "/admin/fees/fees-structure" },
  { label: "Fee Structure", href: "/admin/fees/fees-structure?type=structure" },
  { label: "Fine Management", href: "/admin/fees/fees-structure?type=fine" },
  { label: "Refund Reasons", href: "/admin/fees/fees-structure?type=refund" },
];
    ...
    {type === "fees-structure" && 
      ...
      <div className="bg-white rounded-xl border border-gray-200 mt-2">
        ...
        <div className="px-4 py-3 flex justify-between border-b border-gray-200">
          <div>
            <h2 className="text-sm font-semibold">Fees Types</h2>
            <p className="text-xs text-gray-500">
              Manage all available fee types
            </p>
          </div>
        ...
        <table className="w-full text-xs border-collapse">
          ...
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 py-2 text-left">Total Structures</th>
            </tr>
          </thead>
